...
export function getTagPath(tagName: string, lang: Language): string {
  return getTaxonomyPath('tags', tagName, lang)
}

export function getCategoryPath(categoryName: string, lang: Language): string {
  return getTaxonomyPath('categories', categoryName, lang)
}

function getTaxonomyPath(kind: 'tags' | 'categories', value: string, lang: Language): string {
